...
\addcontentsline{toc}{subsection}{React Native can Solve our Problem?}
React Native is More based on ReactJS which is Frontend framwork and React Native is Usage Similar type of syntax in react native so 
